...
# - Por padrao a função deszipa os arquivos no diretório de trabalho, e com o formato zip. Setados ou nao os parametros, a funcao buscara unzipar todos os arquivos
